...
export const HeroTitle: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-text leading-tight tracking-tight">
        Développez votre{" "}
        <span className="text-text-muted block">forme physique</span>
        <span className="text-primary inline-block">
          ...
          <span className="relative inline-flex w-[300px] sm:w-[400px] md:w-[460px] lg:w-[520px] xl:w-[600px] h-[3rem] sm:h-[3.5rem] md:h-[4rem] lg:h-[4.5rem] xl:h-[5.8rem] overflow-hidden text-left items-center">
            <span className="whitespace-nowrap leading-none">
              {displayedText}
              <span
                className={`inline-block w-0.5 h-8 sm:h-10 md:h-11 lg:h-12 xl:h-16 bg-primary ml-1 ${
      ...
      <p className="text-lg sm:text-xl lg:text-2xl text-text-muted leading-relaxed max-w-xl font-light">
